...
A public release or hackathon submission is ready only when all of the following are true:
...
- [ ] README, SECURITY, ARCHITECTURE, PROVENANCE and PUBLIC_PRIVATE_BOUNDARY match the actual repository contents.
